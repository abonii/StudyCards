...
//        buttonBuffer[pos]?.let { buttonList.addAll(it) }
//        buttonBuffer.clear()
//    }
//
...
//                }
//                translationX =
//                    dX * buffer.size.toFloat() * (buttonWidth * 1).toFloat() / itemView.width
...
//            b.onDraw(
//                c,
//                RectF(left + 10.dp(), itemView.top.toFloat(), right+10.dp(), itemView.bottom.toFloat()),
//                pos
//            )
//            right = left
//        }
