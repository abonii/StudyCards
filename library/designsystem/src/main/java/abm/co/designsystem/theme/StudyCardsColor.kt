...
internal val DarkColors = StudyCardsColor(
    ...
    onyx = Color(0xFF_AFAFAF),
    skyBlue = Color(0xFF_4E7A96),
    silver = Color(0xFF_9E9E9E),
    stroke = Color(0xFF_A8A8A8),
    selfish = Color(0xFF_000000),
    grayishBlue = Color(0xFF_4F4F4F),
    middleGray = Color(0xFF_7A7A7A),
    gray = Color(0xFF_4F4F4F),
    grayishBlack = Color(0xFF_555555),
    grayishWhite = Color(0xFF_878787),
